<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Logohu.aspx.cs" Inherits="ITravel.Logohu" %>
...
<div class="login-card">
  ...
  <form>
    ...
    <asp:Button ID="Button1" runat="server" Text="Valido" OnClick="logohu_Click" style="text-align:center"  Width="86px" />
      <asp:Label ID="lblError"  ForeColor="red" runat="server" style="top:20px"></asp:Label>
  </form>
    
  <div class="login-help">
       <asp:HyperLink id="regj" NavigateUrl="Regjistrohu.aspx" Text="Regjistrohu" ForeColor="black" Font-Underline="false" runat="server"/>  •
     <asp:HyperLink ID="hyperlink2" runat="server" NavigateUrl="~/Resetpassword.aspx" ForeColor="black" Font-Underline="false"> Harruat Fjalekalimin?</asp:HyperLink>
  </div>
</div>
